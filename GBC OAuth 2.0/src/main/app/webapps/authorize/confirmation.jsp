...
<div class="gform_wrapper">
 ...
 <div>
 <h4>Click the link below to confirm with SCE that you authorize data sharing</h4>
</div>

<p><a class="gform_button button" href="#[flowVars['RedirectURL']]">Continue authorization process SCE Account</a></p>
...
<footer class="content-info" role="contentinfo">
    ...
    <li class="active dropdown menu-contact-us"><a href="http://energycoalition.org/contact-us/">Contact Us <b class="caret"></b></a>
    </li>
    </ul>		<div class="social">
    </div><!-- col -->
	</div><!-- blue -->
